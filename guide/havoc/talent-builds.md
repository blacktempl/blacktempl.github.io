...
<ul>
<li>{{ site.data.talent.Insatiable_Hunger }} Достаточно простой талант {{ site.data.spell.Demons_Bite }} генерирует от 5 до 10 дополнительной гнева за применение. Хорошо, но недостаточно.</li> 
