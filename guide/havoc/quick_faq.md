...
<a class="tabs__link" href="#content-3">Рейд СТ</a>
<a class="tabs__link" href="#content-4">Рейд СТ Теория</a>
</div>
...
<b>Набор талантов через {{ site.data.talent.Cycle_of_Hatred }}.</b><br>

В шестом тире талантов можно использовать {{ site.data.talent.Unleashed_Power }}.
<br>
...
<br>
<blockquote>Используем легендарный предмет {{ site.data.legendary.Collective_Anguish }} </blockquote>
В ротации не используется {{ site.data.spell.Blade_Dance }}
А {{ site.data.spell.Death_Sweep }} используем только на 3+ цели<br><br>

<hr>

<br>
<b>Набор талантов через {{ site.data.talent.First_Blood }}.</b><br>
...
<br>
<blockquote>Используем легендарный предмет {{ site.data.legendary.Collective_Anguish }} </blockquote>
В ротации используется {{ site.data.spell.Blade_Dance }} используем только на 3+ цели 
А {{ site.data.spell.Death_Sweep }} используем только на 2+ цели   
...
#### Во всех билдах можно использовать {{ site.data.talent.Demonic }} вместо {{ site.data.talent.Momentum }}.
...
2. Вентиры <img src="{{ site.url }}/assets/img/guide/havoc/venthyr.png" width="16" height="24">
3. Кирии <img src="{{ site.url }}/assets/img/guide/havoc/kyrian.png" width="16" height="24">
4. Некролорды <img src="{{ site.url }}/assets/img/guide/havoc/nekrolords.png" width="16" height="24">
...
2. Вентиры <img src="{{ site.url }}/assets/img/guide/havoc/venthyr.png" width="16" height="24">
3. Ночной народец <img src="{{ site.url }}/assets/img/guide/havoc/nightfae.png" width="22" height="22"> 
4. Некролорды <img src="{{ site.url }}/assets/img/guide/havoc/nekrolords.png" width="16" height="24">

> У Кирий в М+ контенте лидирующая позиция, хороший урон абилки ковенанта, хорошие медиумы. Но есть и минус, Кирии не лучший выбор для рейда. Если вы осваиваете рейдовый контент я вам советую брать универсальный ковенант <img src="{{ site.url }}/assets/img/guide/havoc/venthyr.png" width="16" height="24"> Вентиры или <img src="{{ site.url }}/assets/img/guide/havoc/nightfae.png" width="22" height="22"> Ночной народец, если нет то берите <img src="{{ site.url }}/assets/img/guide/havoc/kyrian.png" width="16" height="24"> Кирии
...
<a href="https://ru.wowhead.com/soulbind-calc/embed/venthyr/nadjia-the-mistblade/demon-hunter/ApavAgUrbwAVK5MAEQUszwAhFSr6AA" target="blank">anything</a>

> Для М+ и АоЕ заменяем проводник {{ site.data.conduits.Demons_Touch }} на {{ site.data.conduits.Growing_Inferno }}, а вместо {{ site.data.covenant.Dauntless_Duelist }} берем {{ site.data.covenant.Exacting_Preparation }}.
...
<a href="https://ru.wowhead.com/soulbind-calc/embed/kyrian/pelagos/demon-hunter/ApZmEgUszwAVLR8AIhUq-gAlKu8A" target="blank">anything</a>
...
<a href="https://ru.wowhead.com/soulbind-calc/embed/night-fae/niya/demon-hunter/ApZlAQUrbwARBSzPACIVKvoAJSrvAA" target="blank">anything</a>
...
> Для М+ и АоЕ заменяем проводник {{ site.data.conduits.Demons_Touch }} на {{ site.data.conduits.Growing_Inferno }}.
...
Лучшим медиумом для нас будет **Эмени**, дерево прокачки медиума выглядит следующим образом:
...
* {{ site.data.conduits.Repeat_Decree }} — способность {{ site.data.covenant.Elysian_Decree }} устанавливает вторую руну через 1 секунду, которая наносит 25% урона. Усиливает и без того сильную способность ковенанта, но нужен высокий илвл кондуита.
* {{ site.data.conduits.Demons_Touch }} —  {{ site.data.spell.Chaos_Strike }} с вероятностью 5,0%-14,5% сработает еще раз. Очень сильный кондуит для СТ боев.
* {{ site.data.conduits.Growing_Inferno }} — урон способности {{ site.data.spell.Immolation_Aura }} дополнительно увеличивается на 10-24% каждый раз, когда она наносит урон. Очень сильно увеличивает урон от {{ site.data.spell.Immolation_Aura }}, используем всегда.
...
ПРИОРИТЕТЫ СОСТАВЛЕНЫ ИЗ СИМА ПЕРСОНАЖА 226 ИЛВЛА В БИС ШМОТЕ, ДЛЯ МАКСИМАЛЬНО ТОЧНЫХ ДАННЫХ ДЛЯ ВАШЕГО ПЕРСОНАЖА ИСПОЛЬЗУЙТЕ РЕЙДБОТС. 
...
<img src="{{ site.url }}/assets/img/guide/havoc/agil.png" width="30" height="30"> **Ловкость >** <img src="{{ site.url }}/assets/img/guide/havoc/speed.png" width="30" height="30"> **Скорость >** <img src="{{ site.url }}/assets/img/guide/havoc/crit.png" width="30" height="30">  **Критический удар >** <img src="{{ site.url }}/assets/img/guide/havoc/vers.png" width="30" height="30"> **Универсальность >** <img src="{{ site.url }}/assets/img/guide/havoc/mastry.png" width="30" height="30"> **Искусность** 
...
* {{ site.data.item.Hateful_Chain }} - Аксессуар с неплохими показателями урона, в средний оверол 3%.
* {{ site.data.item.Infinitely_Divisible_Ooze }} - примерный оверол 2.5-3%
* {{ site.data.item.Dreadfire_Vessel }}
