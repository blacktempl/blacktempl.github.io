...
<li>{{ site.data.spell.Demon_Blades }}: Наносит урон по одной цели и генерирует гнев.</li>
<li>{{ site.data.spell.Blade_Dance }}: Наносит урон всем ближайшим целям.</li>
<li>{{ site.data.spell.Chaos_Strike }}: Использует гнев и наносит урон одной цели.</li>
...
5. {{ site.data.spell.Death_Sweep }}если 3+ целей.<br>
6. {{ site.data.spell.Blade_Dance }} если 5+ целей.<br>
7. {{ site.data.spell.Immolation_Aura }}<br>
8. {{ site.data.spell.Annihilation }}<br>
9. {{ site.data.spell.Chaos_Strike }}<br>
10. {{ site.data.spell.Eye_Beam }}<br>
...
4. {{ site.data.spell.Death_Sweep }}
5. {{ site.data.spell.Blade_Dance }}<br>
6. {{ site.data.spell.Immolation_Aura }}<br>
7. {{ site.data.spell.Annihilation }}<br>
8. {{ site.data.talent.Felblade }} если у вас меньше 80 гнева.<br>
9. {{ site.data.spell.Chaos_Strike }}<br>
10. {{ site.data.spell.Eye_Beam }}<br>
