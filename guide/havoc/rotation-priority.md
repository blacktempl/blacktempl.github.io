...
<li>{{ site.data.spell.Darkness }}: У игроков в радиусе 8 ярдов есть шанс избежать всего урона от атаки в течение 8 секунд. Очень хорошая защитная способность, наиболее эффективно используется при пульсирующем (АоЕ босса, АоЕ кливы босса) групповом уроне, чтобы получить от нее максимальный эффект</li>
</ul>
