...
Для Охотника на Демонов специализации Истребления хорошим выбором буде ковенант <span style="color:#68ccef;font-size:1em;"><img src="{{ site.url }}/assets/img/guide/havoc/kyrian.png" width="16" height="24"> <b>Кирий</b></span>. Лучший медиум для нас это **Пелагий**. 
