...
Во всех типах контента для Охотника на Демонов специализации Месть оптимальным выбором ковенанта будут<span style="color:#68ccef;font-size:1.5em;"><img src="{{ site.url }}/assets/img/guide/havoc/kyrian.png" width="32" height="45"> Кирии</span> с медиумом **Пелагий**
