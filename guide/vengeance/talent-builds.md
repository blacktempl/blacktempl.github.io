...
Это довольно серьезный нерф <a href="https://ru.wowhead.com/spell=247454/">Взрывной души</a> в бою с более чем 5 целями. Тем не менее, это по-прежнему самый сильный ДПС вариант в сочетании с новым легендарным предметом для ковенанта **Кирий** <a href="https://ru.wowhead.com/spell=355893/">Слепая вера</a>.
 ...
 <summary><i>История изменений</i></summary>
    <details open>
     <summary><i>Патч 9.1</i></summary>
      <ul>
        <li><a href="https://ru.wowhead.com/spell=217996/">Раздирание души</a> - увеличивает самоисцеление на 10% (было 5%) и еще на 20% (было 25%), пока действует <a href="https://ru.wowhead.com/spell=187827">Метаморфоза</a>.</li> 
      </ul>
    </details>
</details>
<br>
