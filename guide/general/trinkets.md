...
* {{ site.data.covenant.Dauntless_Duelist }} - сильный трейт дающий нам 3% дополнительного урона по цели котораю мы атакуем, очень сильный трет для СТ боев. 
...
{{ site.data.covenant.Let_Go_of_the_Past }} был чрезвычайно силен для нас, но после изменения, которое изменило бафф универсальности на уменьшение магического урона.
...
<span style="color:#a330c9;font-size:1em;"><img src="{{ site.url }}/assets/img/guide/havoc/nightfae.png" width="16" height="24"> <b>Ночной народец</b></span> - после последний изменений {{ site.data.covenant.The_Hunt }} стала очень сильной способностью и отлично скалируется от Скорости и Крита, ковенант подойдет для PvP и рейдов, так как АоЕ урон самая слабая сторона ковенанта, жесткий кап в 5 целей, нужно отходить от группы мобов чтоб повесить ДоТ на группу мобов. Если танк кайтит пак шанс повесить на мобов ДоТ стремиться к 0.
